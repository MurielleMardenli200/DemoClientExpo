        ...
        {!quizFinished && (
          <View style={styles.quizCardContainer}>
            <Swiper
              ...
              verticalSwipe={false}
              onSwipedLeft={
                totalCards === QUIZ_DATA.length - 1
                  ? handleEndOfQuiz
                  : (cardIndex) => handleSwipe(cardIndex, false)
              }
              onSwipedRight={
                totalCards === QUIZ_DATA.length - 1
                  ? handleEndOfQuiz
                  : (cardIndex) => handleSwipe(cardIndex, true)
              }
              cards={QUIZ_DATA}
              overlayLabels={{
                left: {
        ...
        {!quizFinished && (
          <View style={styles.quizFooter}>
            <Text style={styles.quizFooterText}>
              Le plastique est-il correctement identifié ?
            </Text>
          </View>
        )}
