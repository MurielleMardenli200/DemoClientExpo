      ...
      <View style={styles.imageWrapper}>
        <ImageBackground source={wave} style={styles.imageBackground}>
          <View style={styles.imageBackgroundContent}>
            ...
            {avatarUri !== '' && (
              <Avatar.Image size={scale(60)} source={{ uri: avatarUri }} />
            )}
          </View>
          <Text style={styles.welcomeText}>{homeMessage}</Text>
          <Button
            mode={'contained'}
            ...
            buttonColor="white"
            onPress={() => {
              showSampleChoiceModal();
            }}
          >
            <Text style={styles.samplingButtonText}>TEST prélèvement</Text>
          </Button>
        </ImageBackground>
      </View>
      <CombinedModal
        isVisible={sampleChoiceModalVisible}
        onClose={hideSampleChoiceModal}
      />
      <View style={styles.homeBody}>
        ...
        >
          <View style={styles.homeScrollViewHeader}>
            <Text style={styles.homeScrollViewHeaderTitle}>
              Le compte rendu de votre dernière collecte est disponible !
            </Text>
            <Button
              mode="contained"
              buttonColor={'#232348'}
              ...
              onPress={() => {
                router.push('/Home/SamplingSummary');
              }}
            >
              <Text style={styles.samplingSummaryButtonText}>
                Voir compte rendu
              </Text>
            </Button>
          </View>
          <View style={styles.homeScrollViewFeature}>
            <Text style={styles.homeScrollViewFeatureTitle}>
              Projets récents de FLOW
            </Text>
            <Link href={'https://www.flow'} asChild>
              <Pressable>
                <Image
                  source={ALaUneFLOW}
                  resizeMethod="scale"
                  style={styles.featuredFLOWImage}
                ></Image>
              </Pressable>
            </Link>
          </View>
