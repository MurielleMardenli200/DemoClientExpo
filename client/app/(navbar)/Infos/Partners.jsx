  ...
  return (
    <View style={styles.view}>
      ...
      <View style={styles.partnersBody}>
        ...
        >
          <ImageBackground
            imageStyle={styles.partnersImageBackgroundRadius}
            source={partners_images.jeffImgBackground}
            style={styles.partnersImageBackground}
          >
            <Image
              source={partners_images.cnrsLogo}
              resizeMethod="scale"
              style={styles.partnerImgBackgroundIconLeft}
            />
            <Text style={styles.partnerJeffText}>
          ...
          >
            <Image
              source={partners_images.taraFondationLogo}
              resizeMethod="scale"
              style={styles.partnerImgBackgroundIconRight}
            />
            <Link href={'https://fondati'} asChild>
              <Button
                mode="contained"
                textColor="#0E4093"
                buttonColor="#fff"
          ...
          >
            <Image
              source={partners_images.shakeLogo}
              resizeMethod="scale"
              style={styles.partnerImgBackgroundIconLeft}
            />
            <Link href={'https://s'} asChild>
              <Button
                mode="contained"
                textColor="#0E4093"
                buttonColor="#fff"
          ...
          >
            <Image
              source={partners_images.betreeLogo}
              resizeMethod="scale"
              style={styles.partnerImgBackgroundIconCenter}
            />
            <Link href={'https://www.wear'} asChild>
              <Button
                mode="contained"
                textColor="#0E4093"
                buttonColor="#fff"
          ...
          <ImageBackground
            imageStyle={styles.partnersImageBackgroundRadius}
            source={partners_images.rotaryImgBackground}
            style={styles.partnersImageBackground}
          >
            <Image
              source={partners_images.rotaryFoundationLogo}
              resizeMode="contain"
              resizeMethod="scale"
              style={styles.rotaryFoundationLogo}
            />
          </ImageBackground>
        </ScrollView>
      </View>
